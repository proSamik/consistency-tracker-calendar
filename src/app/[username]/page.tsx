...
/**
 * Dynamic public profile page accessible via /:username
 * Displays public information including social media profiles
...
export default function UserProfilePage() {
      ...
      try {
        ...
        if (!response.ok) {
          if (response.status === 404) {
            // We'll handle 404 in the render method
            setUserData(null)
            return
          }
  ...
  // If user data is missing at this point, show not found
  if (!userData) {
    notFound()
  }
